...
{
    [SerializeField]
    private InputActionReference cameraMove;
    ...
    void Update()
    {
        var moveInput = cameraMove.action.ReadValue<Vector2>();
        ...
        var newTransform = moveRotation * moveDifference * cameraMoveRate * Time.deltaTime;
